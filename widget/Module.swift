  ...
  public func definition() -> ModuleDefinition {
    ...
    Function("startActivity") { (bottomText: String) -> Void in
      ...
      if #available(iOS 16.2, *) {
        ...
        let attributes = TapsActivityAttributes(
          timer: Date.now...future, teamNameLeft: "Knights", teamNameRight: "Pirates",
          gameName: "Western Conference Round 1")
    ...
    Function("updateActivity") { (bottomText: String) -> Void in
      ...
      if #available(iOS 16.2, *) {
        ...
        let alertConfiguration = AlertConfiguration(
          title: "Score update", body: "This is the alert text", sound: .default)
